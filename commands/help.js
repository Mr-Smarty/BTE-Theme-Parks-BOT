exports.run = (client, message, args) => {
    ...
    switch (args[0]) {
        ...
        case 'score': {
            ...
            .addField('Levels:', `<@&${client.ids.level1}> 4 points \n<@&${client.ids.level2}> 8 points \n<@&${client.ids.level3}> 12 points \n<@&${client.ids.level4}> 16 points \n<@&${client.ids.level5}> 20 points \n<@&${client.ids.level6}> 30 points \n<@&${client.ids.sBuilder}> 40 points`)
